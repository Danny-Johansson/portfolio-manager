...
class RolePolicy
{
    ...
    {
        return Auth::user()->role->permissions->contains(Permission::firstWhere('name','=','roles_index'))
            ? Response::allow()
    ...
    {
        return Auth::user()->role->permissions->contains(Permission::firstWhere('name','=','roles_deleted'))
            ? Response::allow()
            : Response::deny('you are not the chosen one')
        ;
    }
    ...
    {
        return Auth::user()->role->permissions->contains(Permission::firstWhere('name','=','roles_update'))
            ? Response::allow()
            : Response::deny('you are not the chosen one')
        ;
    }
    ...
    {
        return Auth::user()->role->permissions->contains(Permission::firstWhere('name','=','roles_deleteForce'))
            ? Response::allow()
            : Response::deny('you are not the chosen one')
        ;
    }
